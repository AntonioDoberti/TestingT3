...
RSpec.describe ContactMessage, type: :model do
  before do
    @contact_message = ContactMessage.new(title: 'John1John1John1John1John1John1John1John1John1John1
        John1John1John1John1John1John1John1John1John1', body: 'Nonono123!',
                                          name: 'John1', mail: 'as@gmail.com', phone: '+56912345678')
  end
...
RSpec.describe ContactMessage, type: :model do
  before do
    ...
    @contact_message = ContactMessage.new(title: 'John1', body: @long, name: 'John1', mail: 'as@gmail.com',
                                          phone: '+56912345678')
  end
...
RSpec.describe ContactMessage, type: :model do
  before do
    @contact_message = ContactMessage.new(title: 'John1', body: 'Nonono123!',
                                          name: 'John1John1John1John1John1John1John1
        John1John1John1John1John1John1John1John1John1John1',
                                          mail: 'as@gmail.com', phone: '+56912345678')
  end
...
RSpec.describe ContactMessage, type: :model do
  before do
    @contact_message = ContactMessage.new(title: 'John1', body: 'Nonono123!',
                                          name: 'John1', mail: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
        aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaas@gmail.com',
                                          phone: '+56912345678')
  end
